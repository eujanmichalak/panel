          ...
          {isEditing ? (
            ...
            <div className="flex items-center gap-2 animate-in slide-in-from-right-2">
              <button 
                ...
                disabled={loading}
                className="bg-red-600 text-white px-4 py-2 rounded-xl text-[10px] uppercase tracking-tighter hover:bg-red-700 transition-all active:scale-95 flex items-center gap-1"
              >
